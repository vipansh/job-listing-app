...
function getJobListingHTML(jobData, filterTags = []) {
  ...
  // }
  if (jobData.new) {
    newData = ` <span class="newData"> NEW! </span>`;
  } else {
    newData = "";
  }
  if (jobData.featured) {
    featuredData = `<span class="featuredData"> FEATURED</span>`;
  } else {
    featuredData = "";
  }
        ...
        <div class="jobs__item">
            <div class="jobs__column jobs__column--left">
                ...
                <div class="jobs__info">
                    <span class="jobs__company">${jobData.company}  ${newData} ${featuredData}</span>
